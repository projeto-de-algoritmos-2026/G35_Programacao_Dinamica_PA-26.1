def calcular_importancia(peso_disciplina, dificuldade, dias_prova):

    dias_reais = max(1, dias_prova)

    importancia = (peso_disciplina * dificuldade * 100) / dias_reais
...
def otimizar_estudos(disciplinas, horas_disponiveis):
    ...
    for d in disciplinas:
        valores.append(calcular_importancia(d['peso'], d['dificuldade'], d['dias_prova']))
